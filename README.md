...
[![Open T4 in Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Jenoxx123/2A202600373_HuynhThaiBao_Day22/blob/main/colab/Lab22_DPO_T4.ipynb)
...
```bash
git clone https://github.com/Jenoxx123/2A202600373_HuynhThaiBao_Day22.git
cd 2A202600373_HuynhThaiBao_Day22
...
1. **Fork hoặc copy repo này lên GitHub account của bạn**, set repo **public**.
   ```bash
   git init -b main
   git remote add origin https://github.com/Jenoxx123/2A202600373_HuynhThaiBao_Day22.git
   ```
